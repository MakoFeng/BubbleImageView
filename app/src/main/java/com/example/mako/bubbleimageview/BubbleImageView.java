package com.example.mako.bubbleimageview;
...
public class BubbleImageView extends ImageView {
    ...
    private int mArrowLeft = dp2px(40);//气泡距离左边的距离
    private int mArrowWidth = dp2px(20);//气泡边上的宽度
    private int mArrowHeight = dp2px(20);//气泡边上的高度
    private int mArrowOffset = 0;//箭头上下的偏移量，正数 向左 ，负数 向右
    ...
    private void initView(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mArrowLeft = (int) a.getDimension(R.styleable.BubbleImageView_bubble_arrowLeft, mArrowLeft);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        path.lineTo(rect.right, rect.bottom - mArrowHeight);
        path.lineTo(rect.left + mArrowLeft + mArrowWidth, rect.bottom - mArrowHeight);
        path.lineTo(mArrowLeft + mArrowWidth / 2 - mArrowOffset, rect.bottom);
        path.lineTo(mArrowLeft, rect.bottom - mArrowHeight);
        path.lineTo(rect.left, rect.bottom - mArrowHeight);
...
//        path.lineTo(rect.width(), rect.top);
//        path.arcTo(new RectF(rect.right - mAngle * 2 - mArrowWidth, rect.top, rect.right - mArrowWidth, mAngle * 2
//                + rect.top), 270, 90);
...
//        path.arcTo(new RectF(rect.right - mAngle * 2 - mArrowWidth, rect.bottom - mAngle * 2, rect.right - mArrowWidth,
//                rect.bottom), 0, 90);
...
//    }
//
//    public void bottomPath(RectF rect, Path path) {
//        path.moveTo(mAngle, rect.top);
//        path.lineTo(rect.width(), rect.top);
//        path.arcTo(new RectF(rect.right - mAngle * 2 - mArrowWidth, rect.top, rect.right - mArrowWidth, mAngle * 2
//                + rect.top), 270, 90);
//        path.lineTo(rect.right, rect.bottom - mArrowWidth);
//        path.arcTo(new RectF(rect.right - mAngle * 2 - mArrowWidth, rect.bottom - mAngle * 2, rect.right - mArrowWidth,
//                rect.bottom), 0, 90);
//
//        path.lineTo(rect.left + mArrowTop + mArrowHeight, rect.bottom - mArrowWidth);
...
//        path.arcTo(new RectF(rect.left + mArrowWidth, rect.bottom - mAngle * 2, mAngle * 2 + rect.left + mArrowWidth,
//                rect.bottom), 90, 90);
...
//        path.arcTo(new RectF(rect.left + mArrowWidth, rect.top, mAngle * 2 + rect.left + mArrowWidth, mAngle * 2
//                + rect.top), 180, 90);
//
//        path.close();
//    }
